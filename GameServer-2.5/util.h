...
static auto StaticLoadObjectInternal = reinterpret_cast<UObject * (*)(UClass * InClass, UObject * InOuter, const TCHAR * Name, const TCHAR * FileName, uint32_t LoadFlags, UPackageMap * Sandbox, bool bAllowObjectReconciliation)>(uintptr_t(GetModuleHandle(NULL)) + 0x13A3980);
...
static T* FindObjectFast(std::string ObjectName, UClass* ObjectClass = UObject::StaticClass())
{
    ...
    auto StaticFindObject = (T * (*)(UClass*, UObject * Package, const wchar_t* OrigInName, bool ExactClass))((uintptr_t)GetModuleHandleA(0) + 0x13A2700);
...
public:
    ...
    static ActorType* SpawnActor(UClass* Class, FVector Location, FRotator Rotation = FRotator(), FVector Scale3D = FVector(1, 1, 1))
    {
        ...
        auto Actor = Globals::GetGameplayStatics()->BeginDeferredActorSpawnFromClass(Globals::GetWorld(), Class, Transform, ESpawnActorCollisionHandlingMethod::AdjustIfPossibleButAlwaysSpawn, nullptr);
