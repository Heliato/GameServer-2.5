...
void UXpBarXpText_C::ExecuteUbergraph_XpBarXpText(int32 EntryPoint, const struct FFortPublicAccountInfo& K2Node_CustomEvent_NewInfo, TDelegate<void(const struct FFortPublicAccountInfo& NewInfo)> K2Node_CreateDelegate_OutputDelegate, class UFortMcpContext* CallFunc_GetContext_ReturnValue, const struct FFortPublicAccountInfo& CallFunc_GetCurrentlyViewedAccountInfo_Result)
{
