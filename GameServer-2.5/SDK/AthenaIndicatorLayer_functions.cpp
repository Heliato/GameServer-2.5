...
// TDelegate<void(class AActor* PointOfInterest, class FText DisplayText, class UTexture2D* DisplayImage)>K2Node_CreateDelegate_OutputDelegate                   (ZeroConstructor, NoDestructor)
...
// TDelegate<void(class AActor* PointOfInterest)>K2Node_CreateDelegate_OutputDelegate1                  (ZeroConstructor, NoDestructor)
...
void UAthenaIndicatorLayer_C::ExecuteUbergraph_AthenaIndicatorLayer(int32 EntryPoint, int32 Temp_int_Array_Index_Variable, int32 CallFunc_Array_Length_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue1, class UBuildingInfoIndicator_C* CallFunc_Create_ReturnValue, class UInteractionIndicator_C* CallFunc_Create_ReturnValue1, class UFortActorCanvasSlot* CallFunc_AddActorIndicator_ReturnValue, class UFortActorCanvasSlot* CallFunc_AddActorIndicator_ReturnValue1, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable1, TDelegate<void(class AActor* PointOfInterest, class FText DisplayText, class UTexture2D* DisplayImage)> K2Node_CreateDelegate_OutputDelegate, class UAthenaTeamMemberIndicator_C* CallFunc_Array_Get_Item, bool CallFunc_RemoveChild_ReturnValue, TDelegate<void(class AActor* PointOfInterest)> K2Node_CreateDelegate_OutputDelegate1, int32 Temp_int_Loop_Counter_Variable1, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue1, class UFortHUDContext* CallFunc_GetContext_ReturnValue, TArray<class AFortPlayerStateAthena*>& K2Node_Event_PlayerStates, class AFortPlayerStateAthena* CallFunc_Array_Get_Item1, int32 CallFunc_Array_Length_ReturnValue1, bool CallFunc_Less_IntInt_ReturnValue1)
{
	...
	Parms.K2Node_Event_PlayerStates = std::move(K2Node_Event_PlayerStates);
...
void UAthenaIndicatorLayer_C::CreateInterestIndicatorWidget(class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UInterestIndicatorWidget_C* CallFunc_Create_ReturnValue, int32 CallFunc_Array_AddUnique_ReturnValue, class UFortActorCanvasSlot* CallFunc_AddActorIndicator_ReturnValue)
{
	...
	Params::AthenaIndicatorLayer_C_CreateInterestIndicatorWidget Parms{};
