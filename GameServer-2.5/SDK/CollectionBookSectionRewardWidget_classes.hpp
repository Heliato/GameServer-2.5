...
public:
	void ExecuteUbergraph_CollectionBookSectionRewardWidget(int32 EntryPoint, ECollectionBookRewardStatus K2Node_Event_NewStatus, ECollectionBookRewardStatus Temp_byte_Variable, class UWidget* K2Node_Select_Default);
