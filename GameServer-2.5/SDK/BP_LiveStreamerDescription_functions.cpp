...
void UBP_LiveStreamerDescription_C::Is_Viewer_Quest(bool* ViewerQuest, EFortQuestType CallFunc_GetQuestType_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue1, bool CallFunc_BooleanOR_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UBP_LiveStreamerDescription_C::Update_Viewer_Note_Visibility(bool Temp_bool_Variable, ESlateVisibility Temp_byte_Variable, ESlateVisibility Temp_byte_Variable1, bool CallFunc_Is_Viewer_Quest_ViewerQuest, ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
