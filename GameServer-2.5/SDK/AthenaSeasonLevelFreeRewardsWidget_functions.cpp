...
void UAthenaSeasonLevelFreeRewardsWidget_C::UpdateStyling(bool Temp_bool_Variable, class UClass* Temp_class_Variable, class UClass* Temp_class_Variable1, class UFortSeasonPassLevelInfo* CallFunc_GetLevelInfo_ReturnValue, bool CallFunc_IsFreeUnlocked_ReturnValue, class UClass* K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
	...
	Params::AthenaSeasonLevelFreeRewardsWidget_C_UpdateStyling Parms{};
