...
void UUIManager_C::ExecuteUbergraph_UIManager(int32 EntryPoint, ESlateVisibility Temp_byte_Variable, ESlateVisibility Temp_byte_Variable1, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsGamepadAttached_ReturnValue, bool K2Node_Event_bDisplay, EFortUIState CallFunc__BPGetCurrentUIState_ReturnValue, struct FFortErrorInfo& K2Node_Event_Info, bool K2Node_SwitchEnum_CmpSuccess, struct FFortDialogDescription_NUI& K2Node_Event_Description, class UFortUIStateWidget_NUI* K2Node_Event_StateWidget, class UCommonActivatablePanel* K2Node_Event_Panel1, bool Temp_bool_Variable, ESlateVisibility K2Node_Select_Default, class UCommonActivatablePanel* K2Node_Event_Panel, bool CallFunc_IsValid_ReturnValue, int32 CallFunc_GetChildrenCount_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, bool CallFunc_BooleanAND_ReturnValue)
{
...
// TDelegate<void(class UWidget* WebWidget, const class FString& OfferId)>K2Node_CreateDelegate_OutputDelegate12                 (ZeroConstructor, NoDestructor)

void UUIManager_C::BindDelegates(TDelegate<void(bool bConnected)> K2Node_CreateDelegate_OutputDelegate, class UFortMcpContext* CallFunc_GetContext_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue1, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate1, TDelegate<void(class UWidget* WebWidget, const class FString& OfferId)> K2Node_CreateDelegate_OutputDelegate12)
{
	static class UFunction* Func = nullptr;
...
void UUIManager_C::AddActivatablePanelToModalLayer(class UCommonActivatablePanel* ActivatablePanel, class UCommonUIContext* CallFunc_GetContext_ReturnValue, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue, TDelegate<void(class UCommonActivatablePanel* Panel)> K2Node_CreateDelegate_OutputDelegate, class UPanelSlot* CallFunc_AddChild_ReturnValue)
{
	static class UFunction* Func = nullptr;
