...
// Parameters:
// int32                                   Param_AchievedCount                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UCollectionBar_C::GetProgressBarPercentage(int32 Param_AchievedCount, float* Percentage, int32 BarRange, bool CallFunc_Greater_IntInt_ReturnValue, float CallFunc_Conv_IntToFloat_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue1, int32 CallFunc_Max_ReturnValue, int32 CallFunc_Max_ReturnValue1, float CallFunc_Conv_IntToFloat_ReturnValue1, float CallFunc_Divide_FloatFloat_ReturnValue, float CallFunc_FClamp_ReturnValue)
{
	...
	Parms.Param_AchievedCount = Param_AchievedCount;
...
void UCollectionBar_C::Update(float CallFunc_GetProgressBarPercentage_Percentage)
{
	...
	Params::CollectionBar_C_Update Parms{};
