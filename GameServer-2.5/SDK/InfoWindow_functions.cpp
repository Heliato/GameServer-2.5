...
// TDelegate<void(class UFortItemDefinition* Entry_Item_Definition)>K2Node_CreateDelegate_OutputDelegate                   (ZeroConstructor, NoDestructor)
...
void UInfoWindow_C::AddInfo(TArray<class UFortItemDefinition*>& Info_Items, class FText Param_Title, const TArray<class UFortItemDefinition*>& NewLocalVar_0, class UObject* CallFunc_GetItemAt_ReturnValue, class UFortItemDefinition* K2Node_DynamicCast_AsFort_Item_Definition, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UInfoWindow_C::Initialize(class UCommonUIContext* CallFunc_GetContext_ReturnValue, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue)
{
	...
	Params::InfoWindow_C_Initialize Parms{};
