...
int32 UCommonButtonGroup::FindButtonIndex(class UCommonButton* ButtonToFind) const
{
	static class UFunction* Func = nullptr;
...
bool UCommonInputManager::StartListeningForExistingHeldAction(struct FDataTableRowHandle& InputActionDataRow, TDelegate<void()>& CompleteEvent, TDelegate<void(float HeldPercent)>& ProgressEvent)
{
	static class UFunction* Func = nullptr;
...
bool UCommonInputManager::StopListeningForExistingHeldAction(struct FDataTableRowHandle& InputActionDataRow, TDelegate<void()>& CompleteEvent, TDelegate<void(float HeldPercent)>& ProgressEvent)
{
	static class UFunction* Func = nullptr;
...
bool UCommonInputManager::IsPanelOnStack(class UCommonActivatablePanel* InPanel) const
{
	static class UFunction* Func = nullptr;
...
void ICommonListItem::RegisterOnClicked(TDelegate<void(class UUserWidget* Widget)>& Callback)
{
	static class UFunction* Func = nullptr;
...
void UCommonPopupMenu::SetContextProvider(class UObject* Param_ContextProvidingObject)
{
	static class UFunction* Func = nullptr;
...
struct FSlateBrush UCommonUIContext::GetInputActionButtonIcon(struct FDataTableRowHandle& InputActionRowHandle, ECommonInputType InputType) const
{
	static class UFunction* Func = nullptr;
...
void UCommonWidgetSwitcher::SetActiveWidgetIndex_Advanced(int32 Param_Index, bool AttemptActivationChange)
{
	static class UFunction* Func = nullptr;
