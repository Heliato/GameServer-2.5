...
void UScoreBarsScoreMessageItem_C::UpdateValues(int32 CallFunc_Multiply_IntInt_ReturnValue)
{
	...
	Params::ScoreBarsScoreMessageItem_C_UpdateValues Parms{};
...
void UScoreBarsScoreMessageItem_C::Setup(int32 Param_Base_Delta, class FText Name_Text, class UScoreMessageNumber_C* In_Score_Widget, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate)
{
	static class UFunction* Func = nullptr;
