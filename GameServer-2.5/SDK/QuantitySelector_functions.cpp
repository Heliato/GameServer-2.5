...
void UQuantitySelector_C::SetAdditionalText(class FText AdditionalInfoText, ESlateVisibility Temp_byte_Variable, bool CallFunc_TextIsEmpty_ReturnValue, ESlateVisibility Temp_byte_Variable1, bool Temp_bool_Variable, ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
...
void UQuantitySelector_C::CloseSelector(class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue)
{
	...
	Params::QuantitySelector_C_CloseSelector Parms{};
...
void UQuantitySelector_C::SliderValueChanged(float CallFunc_Conv_IntToFloat_ReturnValue)
{
	...
	Params::QuantitySelector_C_SliderValueChanged Parms{};
...
void UQuantitySelector_C::SetupForInputMode(bool IsUsingGamepad, bool CallFunc_IsBROnly_ReturnValue, class UCommonUIContext* CallFunc_GetContext_ReturnValue, ECommonInputType CallFunc_GetCurrentInputType_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue)
{
	static class UFunction* Func = nullptr;
