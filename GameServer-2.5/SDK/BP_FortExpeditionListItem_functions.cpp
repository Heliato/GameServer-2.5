...
void UBP_FortExpeditionListItem_C::Set_Name(class UFortItem* Param_Item, class FText CallFunc_GetDisplayName_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UBP_FortExpeditionListItem_C::Set_Rating(class UFortExpeditionItem* Param_Item, float CallFunc_GetTargetPowerLevel_ReturnValue, int32 CallFunc_FTrunc_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UBP_FortExpeditionListItem_C::Set_Rarity(class UFortItem* Param_Item, EFortRarity CallFunc_GetRarity_ReturnValue, const struct FFortRarityItemData& CallFunc_BPGetRarityData_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UBP_FortExpeditionListItem_C::Set_In_Progress_State(class UFortExpeditionItem* Param_Item, bool Temp_bool_Variable, bool CallFunc_IsExpeditionInProgress_ReturnValue, int32 Temp_int_Variable, int32 Temp_int_Variable1, int32 K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
...
void UBP_FortExpeditionListItem_C::Update_Bang_State(class UFortAccountItem* Param_Item, bool CallFunc_HasBeenSeenLocally_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue)
{
	static class UFunction* Func = nullptr;
