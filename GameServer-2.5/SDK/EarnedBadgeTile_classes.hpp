...
public:
	...
	uint8                                         Pad_34AA[0x3];                                     // 0x0255(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLinearColor                           DarkenBadge;                                       // 0x0258(0x0010)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

public:
	void ExecuteUbergraph_EarnedBadgeTile(int32 EntryPoint, ESlateVisibility Temp_byte_Variable, bool K2Node_Event_IsDesignTime, ESlateVisibility Temp_byte_Variable1, class FText CallFunc_GetDisplayName_ReturnValue, class FText CallFunc_TextToUpper_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, bool Temp_bool_Variable, ESlateVisibility K2Node_Select_Default);
	void Construct();
