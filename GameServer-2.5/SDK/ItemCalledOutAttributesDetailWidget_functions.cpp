...
void UItemCalledOutAttributesDetailWidget_C::ExecuteUbergraph_ItemCalledOutAttributesDetailWidget(int32 EntryPoint, ESlateVisibility Temp_byte_Variable, bool Temp_bool_Variable, ESlateVisibility Temp_byte_Variable1, bool CallFunc_IsValid_ReturnValue, EFortItemType CallFunc_GetSchematicResultType_ReturnValue, EFortItemType CallFunc_GetType_ReturnValue, class UFortItemDefinition* CallFunc_GetSchematicCraftingResultBP_ReturnValue, bool CallFunc_IsValid_ReturnValue1, EFortItemType K2Node_Select_Default, TArray<EFortItemType>& K2Node_MakeArray_Array, bool Temp_bool_Variable1, bool CallFunc_Array_Contains_ReturnValue, ESlateVisibility K2Node_Select1_Default)
{
...
void UItemCalledOutAttributesDetailWidget_C::UpdateStats(int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable1, int32 CallFunc_Add_IntInt_ReturnValue1, bool CallFunc_IsValid_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, const struct FMargin& K2Node_MakeStruct_Margin, int32 Temp_int_Array_Index_Variable1, class UStatsListItemWIdget_C* CallFunc_Array_Get_Item, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, TArray<struct FFortDisplayAttribute>& CallFunc_GetDisplayAttributesToCallOut_Attributes, class UStatsListItemWIdget_C* CallFunc_Create_ReturnValue, const struct FFortDisplayAttribute& CallFunc_Array_Get_Item1, class UWrapBoxSlot* CallFunc_AddChildWrapBox_ReturnValue, int32 CallFunc_Array_Add_ReturnValue, const struct FFortDisplayAttribute& CallFunc_Array_Get_Item12, int32 CallFunc_Array_Length_ReturnValue1, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Array_Length_ReturnValue12, bool CallFunc_Less_IntInt_ReturnValue1, int32 CallFunc_Array_Length_ReturnValue123, bool CallFunc_EqualEqual_IntInt_ReturnValue)
{
	...
	Params::ItemCalledOutAttributesDetailWidget_C_UpdateStats Parms{};
	...
	Parms.CallFunc_GetOwningPlayer_ReturnValue = CallFunc_GetOwningPlayer_ReturnValue;
	Parms.CallFunc_GetDisplayAttributesToCallOut_Attributes = std::move(CallFunc_GetDisplayAttributesToCallOut_Attributes);
	...
	CallFunc_GetDisplayAttributesToCallOut_Attributes = std::move(Parms.CallFunc_GetDisplayAttributesToCallOut_Attributes);
}
...
void UItemCalledOutAttributesDetailWidget_C::Clear_Stats(int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, class UStatsListItemWIdget_C* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue)
{
	...
	Params::ItemCalledOutAttributesDetailWidget_C_Clear_Stats Parms{};
