...
void UBP_FortExpeditionDetailsWidget_C::Refresh_Item_Data(bool CallFunc_IsValid_ReturnValue, class UFortExpeditionItemDefinition* CallFunc_Get_Expedition_Item_Definition_Item_Def)
{
	...
	Params::BP_FortExpeditionDetailsWidget_C_Refresh_Item_Data Parms{};
...
void UBP_FortExpeditionDetailsWidget_C::Set_Name(class UFortItem* Param_Item, class FText CallFunc_GetDisplayName_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UBP_FortExpeditionDetailsWidget_C::Set_Rarity(class UFortItem* Param_Item, EFortRarity CallFunc_GetRarity_ReturnValue, class UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue, const struct FFortRarityItemData& CallFunc_BPGetRarityData_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UBP_FortExpeditionDetailsWidget_C::Set_Description(class UFortItem* Param_Item, class FText CallFunc_GetDescription_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UBP_FortExpeditionDetailsWidget_C::Get_Expedition_Item_Definition(class UFortItem* Param_Item, class UFortExpeditionItemDefinition** Item_Def, class UFortItemDefinition* CallFunc_GetItemDefinitionBP_ReturnValue, class UFortExpeditionItemDefinition* K2Node_DynamicCast_AsFort_Expedition_Item_Definition, bool K2Node_DynamicCast_bSuccess)
{
	static class UFunction* Func = nullptr;
...
void UBP_FortExpeditionDetailsWidget_C::Set_Rating(class UFortExpeditionItem* Param_Item, float CallFunc_GetTargetPowerLevel_ReturnValue, int32 CallFunc_FTrunc_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UBP_FortExpeditionDetailsWidget_C::Open_Build_Expedition_Squad(bool CallFunc_IsValidClass_ReturnValue, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, class UUserWidget* CallFunc_GetCachedWidget_ReturnValue, class UFortExpeditionBuildSquadWidget* K2Node_DynamicCast_AsFort_Expedition_Build_Squad_Widget, bool K2Node_DynamicCast_bSuccess)
{
	...
	Params::BP_FortExpeditionDetailsWidget_C_Open_Build_Expedition_Squad Parms{};
...
// bool                                    K2Node_DynamicCast_bSuccess                            (ZeroConstructor, IsPlainOldData, NoDestructor)
// TDelegate<void(class UFortExpeditionItem* Item)>K2Node_CreateDelegate_OutputDelegate                   (ZeroConstructor, NoDestructor)
// class UFortTooltipUIContext*            CallFunc_GetContext_ReturnValue                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FFortTagUIData                   CallFunc_GetUIDataForTag_OutData                       ()
// bool                                    CallFunc_GetUIDataForTag_ReturnValue                   (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UBP_FortExpeditionDetailsWidget_C::Set_Expedition_Returns_Data(class UFortExpeditionItem* Param_Item, class FName CallFunc_GetExpeditionSquadId_ReturnValue, bool CallFunc_IsExpeditionInProgress_ReturnValue, const struct FGameplayTag& CallFunc_GetVehicleTagFromSquadId_OutFoundVehicleTag, bool CallFunc_GetVehicleTagFromSquadId_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class AFortPlayerController* K2Node_DynamicCast_AsFort_Player_Controller, bool K2Node_DynamicCast_bSuccess, TDelegate<void(class UFortExpeditionItem* Item)> K2Node_CreateDelegate_OutputDelegate, class UFortTooltipUIContext* CallFunc_GetContext_ReturnValue, const struct FFortTagUIData& CallFunc_GetUIDataForTag_OutData, bool CallFunc_GetUIDataForTag_ReturnValue, class UHomeBaseContext* CallFunc_GetContext_ReturnValue1, TArray<class UFortItem*>& CallFunc_GetItemsInSquad_ReturnValue, float CallFunc_CalculateTotalPower_ReturnValue, int32 CallFunc_FTrunc_ReturnValue, float CallFunc_CalculateExpeditionPercentageChanceForSuccess_ReturnValue)
{
	...
	Parms.CallFunc_IsExpeditionInProgress_ReturnValue = CallFunc_IsExpeditionInProgress_ReturnValue;
	Parms.CallFunc_GetVehicleTagFromSquadId_OutFoundVehicleTag = std::move(CallFunc_GetVehicleTagFromSquadId_OutFoundVehicleTag);
