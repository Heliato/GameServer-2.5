...
public:
	...
	uint8                                         Pad_34EE[0x2];                                     // 0x024A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void Initialize(int32 Param_Score, float Param_PlayRate, float CallFunc_Divide_FloatFloat_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue1);
	void SetIsBestScore(bool Param_bIsBestScore, const struct FLinearColor& ScoreColor, class UTexture* Texture, const struct FSlateColor& K2Node_MakeStruct_SlateColor, class UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue);
