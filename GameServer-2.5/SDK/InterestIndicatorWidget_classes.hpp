...
public:
	...
	void Destruct();
	void Construct();
	void SetDisplayText(class FText Description, bool Temp_bool_Variable, bool CallFunc_TextIsEmpty_ReturnValue, ESlateVisibility Temp_byte_Variable, ESlateVisibility Temp_byte_Variable1, ESlateVisibility K2Node_Select_Default);
	void SetDisplayImage(class UTexture2D* Icon, bool Temp_bool_Variable, bool CallFunc_EqualEqual_ObjectObject_ReturnValue, ESlateVisibility Temp_byte_Variable, ESlateVisibility Temp_byte_Variable1, ESlateVisibility K2Node_Select_Default);
