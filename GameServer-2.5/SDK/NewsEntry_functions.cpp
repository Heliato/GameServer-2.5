...
void UNewsEntry_C::HandleEntrySelected__DelegateSignature(class FText Param_BodyText)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_BodyText = Param_BodyText;
...
void UNewsEntry_C::SetFocus(class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue)
{
	...
	Params::NewsEntry_C_SetFocus Parms{};
