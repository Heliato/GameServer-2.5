...
void UXpBoostRow_C::ExecuteUbergraph_XpBoostRow(int32 EntryPoint, EFortDialogResult K2Node_CustomEvent_Result1, class FName K2Node_CustomEvent_ResultName1, TDelegate<void(EFortDialogResult Result, class FName ResultName)> K2Node_CreateDelegate_OutputDelegate, class FName Temp_name_Variable, EFortDialogResult Temp_byte_Variable, bool K2Node_SwitchEnum_CmpSuccess, EFortDialogResult K2Node_CustomEvent_Result, class FName K2Node_CustomEvent_ResultName, TDelegate<void(EFortDialogResult Result, class FName ResultName)> K2Node_CreateDelegate_OutputDelegate1, class FName Temp_name_Variable1, EFortDialogResult Temp_byte_Variable1, bool K2Node_SwitchEnum1_CmpSuccess, class UFortMcpContext* CallFunc_GetContext_ReturnValue, class UFortAccountItem* CallFunc_GetAccountItemWithDefinition_ReturnValue, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate12, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate123, class FText CallFunc_MakeLiteralText_ReturnValue, class FText CallFunc_MakeLiteralText_ReturnValue1, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue1, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue1, class UCommonButton* K2Node_ComponentBoundEvent_Button, class UFortMcpContext* CallFunc_GetContext_ReturnValue1, class UFortAccountItem* CallFunc_GetAccountItemWithDefinition_ReturnValue1, class UFortAsyncAction_MCPContextConsumeItem* CallFunc_ConsumeItem_ReturnValue, class UFortAsyncAction_MCPContextConsumeItem* CallFunc_ConsumeItem_ReturnValue1, bool CallFunc_IsValid_ReturnValue12, bool CallFunc_IsValid_ReturnValue123, const struct FFortTeamMemberInfo& K2Node_Event_NewInfo, bool CallFunc_IsValid_ReturnValue1234)
{
	static class UFunction* Func = nullptr;
...
void UXpBoostRow_C::Center_On_Row(class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue)
{
	...
	Params::XpBoostRow_C_Center_On_Row Parms{};
...
void UXpBoostRow_C::Update_Boost_Material(bool Other_Boosted)
{
	...
	Params::XpBoostRow_C_Update_Boost_Material Parms{};
...
void UXpBoostRow_C::Update_Boost_Amount(const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, class UFortMcpContext* CallFunc_GetContext_ReturnValue, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, int32 CallFunc_GetPlayersXPPercentContributionToLocalPlayer_ReturnValue, class FText CallFunc_Format_ReturnValue, bool CallFunc_NotEqual_IntInt_ReturnValue)
{
	...
	Params::XpBoostRow_C_Update_Boost_Amount Parms{};
