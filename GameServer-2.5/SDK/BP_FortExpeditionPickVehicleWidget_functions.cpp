...
// TDelegate<void(class UCommonButton* Button)>K2Node_CreateDelegate_OutputDelegate123                (ZeroConstructor, NoDestructor)
...
void UBP_FortExpeditionPickVehicleWidget_C::Setup_Input_Action_Handlers(TDelegate<void(bool* bPassThrough)> K2Node_CreateDelegate_OutputDelegate)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_FortExpeditionPickVehicleWidget_C_Setup_Input_Action_Handlers Parms{};
...
void UBP_FortExpeditionPickVehicleWidget_C::Pre_Select_for_Console(class UCommonUIContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsUsingGamepad_ReturnValue, class UObject* CallFunc_GetItemAt_ReturnValue, bool CallFunc_SetSelectedItem_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
	...
	Params::BP_FortExpeditionPickVehicleWidget_C_Pre_Select_for_Console Parms{};
