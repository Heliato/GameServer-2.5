...
public:
	...
	uint8                                         Pad_2F23[0x4];                                     // 0x023C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void Initialize(EFortCompletionResult Result, EFortCompletionResult Temp_byte_Variable, class FText Temp_text_Variable, class FText Temp_text_Variable1, class FText Temp_text_Variable12, class FText Temp_text_Variable123, class FText K2Node_Select_Default);
	void Intro();
