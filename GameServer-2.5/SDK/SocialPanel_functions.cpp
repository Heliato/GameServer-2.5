...
void USocialPanel_C::InitializeInput(bool CallFunc_IsMobileGame_ReturnValue, TDelegate<void(bool* bPassThrough)> K2Node_CreateDelegate_OutputDelegate)
{
	static class UFunction* Func = nullptr;
	...
	Params::SocialPanel_C_InitializeInput Parms{};
