...
public:
	...
	uint8                                         Pad_1FAC[0x2];                                     // 0x027A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1FAD[0x3];                                     // 0x028D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void Intro_Sequence();
	void Initialize(class UFortUIScoreReport* ScoreReport, class UResults_TeamTotalScore_C* Param_TeamTotalScore, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate);
