...
public:
	...
	uint8                                         Pad_2CF5[0x3];                                     // 0x0249(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2CF6[0x7];                                     // 0x0251(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void Construct();
	void SetItemDefinition(class UFortItemDefinition* Param_ItemDefinition, class FText Temp_text_Variable, bool CallFunc_IsValid_ReturnValue, bool Temp_bool_Variable, class FText K2Node_Select_Default);
