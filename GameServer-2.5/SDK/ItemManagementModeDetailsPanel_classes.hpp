...
public:
	void ExecuteUbergraph_ItemManagementModeDetailsPanel(int32 EntryPoint, EFortItemManagementMode Temp_byte_Variable, EFortItemManagementMode CallFunc_GetItemManagementMode_ReturnValue, class UWidget* K2Node_Select_Default);
