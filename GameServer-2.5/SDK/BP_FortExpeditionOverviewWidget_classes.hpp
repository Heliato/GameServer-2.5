...
public:
	...
	void Construct();
	void Setup_Expedition_Details_Widget(class UFortExpeditionItem* Item, ESlateVisibility Temp_byte_Variable, bool CallFunc_IsValid_ReturnValue, ESlateVisibility Temp_byte_Variable1, bool Temp_bool_Variable, ESlateVisibility K2Node_Select_Default);
