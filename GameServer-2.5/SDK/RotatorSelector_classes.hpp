...
public:
	...
	uint8                                         Pad_38DA[0x4];                                     // 0x023C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void ExecuteUbergraph_RotatorSelector(int32 EntryPoint, struct FPointerEvent& K2Node_Event_MouseEvent1, const struct FGeometry& K2Node_Event_MyGeometry, struct FPointerEvent& K2Node_Event_MouseEvent, int32 K2Node_ComponentBoundEvent_Value, class UCommonButton* K2Node_ComponentBoundEvent_Button1, class UCommonButton* K2Node_ComponentBoundEvent_Button);
