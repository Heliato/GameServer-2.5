...
public:
	...
	void OnBeginIntro();
	void BindDelegates(TDelegate<void(class FText& Text)> K2Node_CreateDelegate_OutputDelegate, TDelegate<void(class FText& Text)> K2Node_CreateDelegate_OutputDelegate1);
	...
	void SetupAutoFillPlayerFields(class FText Param_KillersName, class FText Param_SpectatingName, bool CallFunc_TextIsEmpty_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_TextIsEmpty_ReturnValue1, bool CallFunc_Not_PreBool_ReturnValue1);
