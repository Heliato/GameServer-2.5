...
public:
	...
	uint8                                         Pad_E86[0x18];                                     // 0x0040(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_E87[0x70];                                     // 0x0028(0x0070)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E88[0x14];                                     // 0x009C(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E89[0x3E7];                                    // 0x00B1(0x03E7)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_E8A[0x8];                                      // 0x0030(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FUniqueNetIdRepl                       OwningUserId;                                      // 0x0038(0x0028)(Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_E8B[0x58];                                     // 0x0060(0x0058)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E8C[0x18];                                     // 0x00B9(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E8D[0x6];                                      // 0x00D2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E8E[0x108];                                    // 0x00E0(0x0108)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E8F[0x330];                                    // 0x01F8(0x0330)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_E90[0x10];                                     // 0x0070(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E91[0x7];                                      // 0x0081(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
