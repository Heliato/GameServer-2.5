...
void ATrap_Ceiling_Spikes_C::UserConstructionScript(const TArray<struct FTransform>& SocketTransformList, const TArray<class UStaticMesh*>& TireOptions, const TArray<class UStaticMeshComponent*>& Tiress, const TArray<class FName>& SocketNames, TArray<class UStaticMesh*>& K2Node_MakeArray_Array, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue)
{
	...
	Params::Trap_Ceiling_Spikes_C_UserConstructionScript Parms{};

	Parms.SocketTransformList = std::move(SocketTransformList);
	Parms.TireOptions = std::move(TireOptions);
	Parms.Tiress = std::move(Tiress);
...
void ATrap_Ceiling_Spikes_C::MaterialSweepOnSpikes(float Param_SweepSpeed, const struct FLinearColor& Param_SweepColor, float Param_SweepExponent, float CallFunc_GetGameTimeInSeconds_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
struct FTransform ATrap_Ceiling_Spikes_C::GetFireLocationAndRotation(const struct FTransform& CallFunc_K2_GetComponentToWorld_ReturnValue) const
{
	static class UFunction* Func = nullptr;
