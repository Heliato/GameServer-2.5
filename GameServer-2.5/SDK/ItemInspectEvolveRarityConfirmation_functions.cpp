...
// TArray<EItemEvolutionRestrictionReason> CallFunc_CanUpgradeItemRarity_OutRestrictionReasons    (ZeroConstructor, ReferenceParm)
...
// EItemEvolutionRestrictionReason         CallFunc_Array_Get_Item                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UItemInspectEvolveRarityConfirmation_C::SetItemToRepresent(class UFortItem* Param_Item, bool CanUpgradeRarity, bool NoEvolutions, int32 Temp_int_Array_Index_Variable, bool CallFunc_Not_PreBool_ReturnValue, class UFortInventoryContext* CallFunc_GetContext_ReturnValue, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, TArray<EItemEvolutionRestrictionReason>& CallFunc_CanUpgradeItemRarity_OutRestrictionReasons, bool CallFunc_CanUpgradeItemRarity_ReturnValue, int32 CallFunc_GetNumEvolutionOptions_NumRecipes, EItemEvolutionRestrictionReason CallFunc_Array_Get_Item, bool CallFunc_Greater_IntInt_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue)
{
	...
	Parms.CallFunc_CanUpgradeItemRarity_OutRestrictionReasons = std::move(CallFunc_CanUpgradeItemRarity_OutRestrictionReasons);
	...
	CallFunc_CanUpgradeItemRarity_OutRestrictionReasons = std::move(Parms.CallFunc_CanUpgradeItemRarity_OutRestrictionReasons);
}
...
void UItemInspectEvolveRarityConfirmation_C::SetEvolutionToRepresent(int32 EvolutionIndex, class UFortItem* EvolutionItem, const TArray<struct FFortItemQuantityPair>& Ingredients, bool CallFunc_GreaterEqual_IntInt_ReturnValue, class UFortInventoryContext* CallFunc_GetContext_ReturnValue, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue1, class UFortItemDefinition* CallFunc_GetItemDefinitionBP_ReturnValue, const struct FRecipe& CallFunc_GetUpgradeItemRarityRecipeFromItemDefintion_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, const struct FFortItemQuantityPair& CallFunc_Array_Get_Item, class UFortItemDefinition* CallFunc_GetItemFromItemQuantityPair_ReturnValue, class UFortItem* CallFunc_CreateTemporaryItemInstanceBP_ReturnValue, class FText CallFunc_GetDisplayName_ReturnValue)
{
	...
	Parms.CallFunc_GetUpgradeItemRarityRecipeFromItemDefintion_ReturnValue = std::move(CallFunc_GetUpgradeItemRarityRecipeFromItemDefintion_ReturnValue);
	Parms.CallFunc_Array_Length_ReturnValue = CallFunc_Array_Length_ReturnValue;
	Parms.CallFunc_Greater_IntInt_ReturnValue = CallFunc_Greater_IntInt_ReturnValue;
...
void UItemInspectEvolveRarityConfirmation_C::HandleEvolutionOptionSelected(class UFortItem* Param_Item, int32 RecipeIndex, class UFortItem* TempItemForLevel, class UFortItem* CallFunc_Get_Temp_Item_Based_on_Current_Level_NewItem)
{
	static class UFunction* Func = nullptr;
...
// TDelegate<void(class UFortItem* Item, int32 RecipeIndex)>K2Node_CreateDelegate_OutputDelegate                   (ZeroConstructor, NoDestructor)
...
void UItemInspectEvolveRarityConfirmation_C::SetupEvolutionOptions(class UFortItem* TemporaryEvolutionItem, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UItemInspectEvolutionChoiceEntry_C* CallFunc_Create_ReturnValue, class UFortItem* CallFunc_Get_Temp_Item_Based_on_Current_Level_NewItem, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue1, TDelegate<void(class UFortItem* Item, int32 RecipeIndex)> K2Node_CreateDelegate_OutputDelegate, class AFortPlayerController* K2Node_DynamicCast_AsFort_Player_Controller, bool K2Node_DynamicCast_bSuccess, class UFortItemDefinition* CallFunc_GetItemDefinitionBP_ReturnValue, class UFortInventoryContext* CallFunc_GetContext_ReturnValue, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue1, const struct FRecipe& CallFunc_GetUpgradeItemRarityRecipeFromItemDefintion_ReturnValue, class UPanelSlot* CallFunc_AddChild_ReturnValue, const struct FFortItemQuantityPair& CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, class UFortItemDefinition* CallFunc_GetItemFromItemQuantityPair_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UFortItem* CallFunc_CreateTemporaryInstanceFromExistingItemBP_ReturnValue, class UFortMcpContext* CallFunc_GetContext_ReturnValue12, bool CallFunc_IsAllowedConversionIndex_ReturnValue)
{
	...
	Params::ItemInspectEvolveRarityConfirmation_C_SetupEvolutionOptions Parms{};
...
void UItemInspectEvolveRarityConfirmation_C::OnShow(class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue, int32 CallFunc_GetNumEvolutionOptions_NumRecipes, bool CallFunc_Greater_IntInt_ReturnValue, class UWidget* CallFunc_GetChildAt_ReturnValue, class UItemInspectEvolutionChoiceEntry_C* K2Node_DynamicCast_AsItem_Inspect_Evolution_Choice_Entry, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsValid_ReturnValue)
{
	...
	Params::ItemInspectEvolveRarityConfirmation_C_OnShow Parms{};
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// EItemEvolutionRestrictionReason         Temp_byte_Variable                                     (ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UFortInventoryContext*            CallFunc_GetContext_ReturnValue                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FText                             CallFunc_GetEvolveRestrictionReasonText_ReturnValue    ()
// EItemEvolutionRestrictionReason         Temp_byte_Variable1                                    (ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// TArray<EItemEvolutionRestrictionReason> CallFunc_CanUpgradeItemRarity_OutRestrictionReasons    (ZeroConstructor, ReferenceParm)
// bool                                    CallFunc_CanUpgradeItemRarity_ReturnValue              (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UItemInspectEvolveRarityConfirmation_C::SetEvolutionRestrictions(EItemEvolutionRestrictionReason Temp_byte_Variable, class UFortInventoryContext* CallFunc_GetContext_ReturnValue, class FText CallFunc_GetEvolveRestrictionReasonText_ReturnValue, EItemEvolutionRestrictionReason Temp_byte_Variable1, TArray<EItemEvolutionRestrictionReason>& CallFunc_CanUpgradeItemRarity_OutRestrictionReasons, bool CallFunc_CanUpgradeItemRarity_ReturnValue, class FText CallFunc_GetEvolveRestrictionReasonText_ReturnValue1, bool CallFunc_Array_Contains_ReturnValue, bool CallFunc_Array_Contains_ReturnValue1)
{
	...
	Params::ItemInspectEvolveRarityConfirmation_C_SetEvolutionRestrictions Parms{};
