...
// ESlateVisibility                        CallFunc_GetButtonVisibility_NewParam                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FString                           CallFunc_Concat_StrStr_ReturnValue                     (ZeroConstructor, HasGetValueTypeHash)

void UErrorEntry_C::ExecuteUbergraph_ErrorEntry(int32 EntryPoint, class UCommonButton* K2Node_ComponentBoundEvent_Button, ESlateVisibility CallFunc_GetButtonVisibility_NewParam, const class FString& CallFunc_Concat_StrStr_ReturnValue)
{
