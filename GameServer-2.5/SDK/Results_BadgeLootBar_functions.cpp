...
void UResults_BadgeLootBar_C::UpdateAddBadgePoints(float CurrentPointsFloat, float TimePassed, float TargetFillPercentage, float CallFunc_Conv_IntToFloat_ReturnValue, int32 CallFunc_GetNextLootLevelPoints_NextLootLevelPoints, int32 CallFunc_Min_ReturnValue, float CallFunc_Conv_IntToFloat_ReturnValue1, bool CallFunc_EqualEqual_IntInt_ReturnValue, int32 CallFunc_Divide_IntInt_ReturnValue, float CallFunc_Conv_IntToFloat_ReturnValue12, int32 CallFunc_Add_IntInt_ReturnValue, bool CallFunc_NotEqual_IntInt_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue, float CallFunc_FMin_ReturnValue, float CallFunc_GetGameTimeInSeconds_ReturnValue, float CallFunc_FInterpEaseInOut_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue, float CallFunc_Percent_FloatFloat_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue1, int32 CallFunc_FTrunc_ReturnValue)
{
	...
	Params::Results_BadgeLootBar_C_UpdateAddBadgePoints Parms{};
...
void UResults_BadgeLootBar_C::Initialize(float Param_PlayRate, float CallFunc_Divide_FloatFloat_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue1)
{
	static class UFunction* Func = nullptr;
...
void UResults_BadgeLootBar_C::SetSkippingToEnd(int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, bool CallFunc_K2_IsTimerPausedHandle_ReturnValue, bool CallFunc_K2_IsTimerActiveHandle_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, TArray<class UWidgetAnimation*>& K2Node_MakeArray_Array, int32 CallFunc_Array_Length_ReturnValue, class UWidgetAnimation* CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_IsAnimationPlaying_ReturnValue)
{
	...
	Params::Results_BadgeLootBar_C_SetSkippingToEnd Parms{};
