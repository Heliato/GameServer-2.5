...
void UBP_FortExpeditionOverviewWidget_C::Setup_Expedition_Details_Widget(class UFortExpeditionItem* Item, ESlateVisibility Temp_byte_Variable, bool CallFunc_IsValid_ReturnValue, ESlateVisibility Temp_byte_Variable1, bool Temp_bool_Variable, ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
...
void UBP_FortExpeditionOverviewWidget_C::On_Widget_Activated(class UObject* CallFunc_GetItemAt_ReturnValue, bool CallFunc_SetSelectedItem_ReturnValue, class UObject* CallFunc_GetSelectedItem_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_SetSelectedItem_ReturnValue1)
{
	...
	Params::BP_FortExpeditionOverviewWidget_C_On_Widget_Activated Parms{};
...
void UBP_FortExpeditionOverviewWidget_C::Update_List_View_Area(class FName InTabId, class FText Temp_text_Variable, class FText Temp_text_Variable1, class FText Temp_text_Variable12, bool Temp_bool_Variable, int32 Temp_int_Variable, int32 Temp_int_Variable1, bool Temp_bool_True_if_break_was_hit_Variable, int32 Temp_int_Array_Index_Variable, bool CallFunc_Not_PreBool_ReturnValue, int32 Temp_int_Loop_Counter_Variable, class FText Temp_text_Variable123, int32 CallFunc_Add_IntInt_ReturnValue, class FText Temp_text_Variable1234, const struct FExpeditionTabInfo& CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_EqualEqual_NameName_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, int32 Temp_int_Variable12, class FText K2Node_Select_Default, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, int32 CallFunc_GetNumItems_ReturnValue, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, bool CallFunc_Greater_IntInt_ReturnValue, class FText CallFunc_Format_ReturnValue, int32 K2Node_Select1_Default)
{
	...
	Params::BP_FortExpeditionOverviewWidget_C_Update_List_View_Area Parms{};
...
void UBP_FortExpeditionOverviewWidget_C::Update_Details_Visibility(class UObject* CallFunc_GetSelectedItem_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
	...
	Params::BP_FortExpeditionOverviewWidget_C_Update_Details_Visibility Parms{};
