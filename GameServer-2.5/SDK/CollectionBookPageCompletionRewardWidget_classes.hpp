...
public:
	void ExecuteUbergraph_CollectionBookPageCompletionRewardWidget(int32 EntryPoint, ECollectionBookRewardStatus Temp_byte_Variable, ECollectionBookRewardStatus K2Node_Event_NewStatus, class UWidget* K2Node_Select_Default);
