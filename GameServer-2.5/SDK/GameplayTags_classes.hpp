...
public:
	...
	uint8                                         Pad_1F48[0x10];                                    // 0x0038(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F49[0x80];                                    // 0x0028(0x0080)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FGameplayTagSource>             TagSources;                                        // 0x00A8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1F4A[0x68];                                    // 0x00B8(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UDataTable*>                     GameplayTagTables;                                 // 0x0120(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1F4B[0x50];                                    // 0x0130(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1F4C[0x6];                                     // 0x004A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1F4D[0x7];                                     // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
